...
class FraudDetectionSystem:
    ...
    def preprocess_data(self):
        ...
        self.data[['purchase_amount', 'time_spent']] = scaler.fit_transform(self.data[['purchase_amount', 'time_spent']])
    ...
    def train(self):
        ...
        self.classifier = IsolationForest(n_estimators=100, contamination='auto', random_state=42)
    ...
    def detect_fraud(self, new_data):
        ...
        new_data[['purchase_amount', 'time_spent']] = StandardScaler().fit_transform(new_data[['purchase_amount', 'time_spent']])
...
new_transactions = pd.DataFrame([
    {'purchase_amount': -0.8, 'time_spent': -1.2, 'payment_method_credit_card': 1, 'payment_method_paypal': 0, 'payment_method_upi': 0},
    {'purchase_amount': 1.5, 'time_spent': 0.7, 'payment_method_credit_card': 0, 'payment_method_paypal': 1, 'payment_method_upi': 0},
    {'purchase_amount': 0.3, 'time_spent': 1.0, 'payment_method_credit_card': 0, 'payment_method_paypal': 0, 'payment_method_upi': 1}
])
